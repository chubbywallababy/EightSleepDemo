...
export const TossAndTurnCount = ({dataPoint}: TossAndTurnCountProps): JSX.Element => {
    ...
    const bottomCount = dataPoint.data % 2 === 0 ? dataPoint.data / 2 : Math.floor(dataPoint.data / 2) + 1;
                ...
                <View style={styles.tntData}>
                    ...
                    <View style={styles.dots}>
                        <View style={styles.row}>
                            {new Array(topCount).fill("").map((_, i) => <Circle key={i} />)}
                        </View>
                        <View style={styles.row}>
                            {new Array(bottomCount).fill("").map((_, i) => <Circle key={i} />)}
                        </View>
                    </View>
                </View>
            </View>
