 ...
 * @returns 
 */
export const HorizontalDetailScrollView = ({children, title}: HorizontalDetailScrollViewProps) => {
    ...
    return (
        <SleepView setWidth={setWidth}>
            ...
            <View style={styles.buttonContainer}>
                ...
                {currentIdx === 0 ? <View /> : <TouchableOpacity onPress={onLeft} style={styles.scrollButton}>
                    <ChevronLeft />
                </TouchableOpacity>}
                {currentIdx === children.length - 1 ? <View /> : <TouchableOpacity onPress={onRight} style={styles.scrollButton}>
                    <ChevronRight />
                </TouchableOpacity>}
            </View>
        </SleepView>
