        ...
        return (
            <React.Fragment>
                {items.map((item: Item, index: number) => {
                    const {containerTransform, transform, opacity} = getConfettiTransformations(
                        animation,
                        item,
                        width,
                        height,
...
const getConfettiTransformations = (
    ...
    const containerTransform: Interpolations = [{translateX: left}, {translateY: top}];
    const transform: Interpolations = [{rotateX}, {rotateY}, {rotate: rotateZ}, {translateX}];
