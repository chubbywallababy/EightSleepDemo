...
export const GlowingBorder = ({children, shadowColor, delay = 0, duration = 2000, maxShadowOpacity = 1, maxShadowRadius = 10, shadowOffset = {height: 0, width: 0}, hideGlow}: GlowingBorderProps) => {
