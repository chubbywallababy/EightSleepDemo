...
import {SleepTemperatureLineGraphData, TimeseriesDataPoint} from '../utils/types';
            ...
            <View style={graphStyles.container}>
                <LineChart
                    ...
                    pointerConfig={{
                        ...
                        pointerStripWidth: 4,
                        pointerLabelComponent: PointerLabelComponent(dataPoint, 'degrees', [strings.common.bed, strings.common.room]),
                    }}
                    curved
                />
            </View>
