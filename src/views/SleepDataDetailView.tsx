...
import {getHeartRates, getMovements, getRespirations, getSortedStages} from '../utils/SleepDataUtils';
...
type SleepDataDetailViewProps = NativeStackScreenProps<RootStackParamList, 'Details'>;

export const SleepDataDetailView = ({route, navigation}: SleepDataDetailViewProps) => {
    ...
    const getCurrentField = useCallback((data: SleepDataByLineItem) => {
